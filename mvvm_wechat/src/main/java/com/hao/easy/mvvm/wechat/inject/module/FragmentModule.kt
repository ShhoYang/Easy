...
class FragmentModule {
    ...
    @Provides
    internal fun provideWechatViewModel(fragment: Fragment, api: Api): WechatViewModel {
    ...
    @Provides
    internal fun provideWechatArticlesViewModel(fragment: Fragment, api: Api): ArticlesViewModel {
